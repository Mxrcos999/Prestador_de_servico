...
namespace Prestadores_infrastructure.Migrations
{
    ...
    [Migration("20220721182258_teste")]
    partial class teste
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prestadores_Domain.Entities.Service", b =>
                {
                    ...
                    b.Property<int>("ProvidedId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ProvidedId");
            ...
            modelBuilder.Entity("Prestadores_Domain.Entities.Service", b =>
                {
                    b.HasOne("Prestadores_Domain.Entities.Prestador", "Provided")
                        .WithMany("ServiceProvided")
                        .HasForeignKey("ProvidedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
